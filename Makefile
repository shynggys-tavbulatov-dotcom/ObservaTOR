...
SOURCES = src/main.c src/reader.c src/parser.c src/events.c src/structured_event.c src/report.c
TEST_TARGET = build/test_parser
TEST_SOURCES = tests/test_parser.c src/parser.c src/events.c src/structured_event.c
